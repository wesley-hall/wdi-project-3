                            ...
                            <div>
                                <div className="columns">
                                    <div className="column is-full">
                                        ...
                                        <p className="subtitle"><span className="has-text-weight-bold has-text-danger">IMPORTANT:</span> You will also need to wait or manually restart the dynos before the app will be fully functional again on Heroku</p>
                                    </div>
                                </div>

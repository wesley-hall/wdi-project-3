...
const loansData = (books, users) => [
    {
        book: books[0],
        borrower: users[2],
        start: moment().subtract(140, 'days').format(),
        end: moment().subtract(79, 'days').format(),
        message: 'Loan A',
        returned: null,
        approved: true
    },
    {
        ...
        returned: null,
        approved: true,
        collected: moment().subtract(140, 'days').format()
    },
    {
        book: books[90],
        borrower: users[1],
    ...
    },
    {
        book: books[2],
        borrower: users[3],
        start: moment().subtract(85, 'days').format(),
        end: moment().subtract(79, 'days').format(),
        message: 'Loan E',
        returned: moment().subtract(79, 'days').format(),
        approved: true
    },
    {
        book: books[86],
        borrower: users[0],
        start: moment().subtract(79, 'days').format(),
        end: moment().subtract(79, 'days').format(),
        message: 'Loan F',
        returned: moment().subtract(79, 'days').format(),
        approved: true
    ...
    },
    {
        book: books[76],
        borrower: users[3],
        start: moment().subtract(84, 'days').format(),
        end: moment().subtract(79, 'days').format(),
        message: 'Loan H',
        returned: moment().subtract(79, 'days').format(),
        approved: true
    ...
    },
    {
        book: books[6],
        borrower: users[2],
        start: moment().subtract(56, 'days').format(),
    ...
    },
    {
        book: books[5],
        borrower: users[1],
        start: moment().subtract(9, 'days').format(),
        end: moment().add(20, 'days').format(),
        message: 'Loan M',
        returned: null,
        approved: false
    },
